...
例如 想要利用tcl文件生成vivado工程，你需要先cd到vivado_prj文件夹内，你需要修改成你的本地路径。比如cd E:\\digitalLogaic\\finalwork\\FPGA_jump_game_Unit\\vivado_prj

<img src="./pictures/image.png" width="70%">

另一方面，你需要把tcl文件中的srogin_dir改成本地的路径，例如E:/digitalLogaic/finalwork/FPGA_jump_game_Unit
