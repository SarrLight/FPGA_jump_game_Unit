...
set_property PACKAGE_PIN AF8 [get_ports {type_block2[0]}]
set_property PACKAGE_PIN AE13 [get_ports {type_block2[1]}]
set_property PACKAGE_PIN AF13 [get_ports {type_block2[2]}]
set_property PACKAGE_PIN AF12 [get_ports {type_block2[3]}]
set_property PACKAGE_PIN AA13 [get_ports {i_squeeze_man[0]}]
set_property PACKAGE_PIN AA12 [get_ports {i_squeeze_man[1]}]
set_property PACKAGE_PIN Y13 [get_ports {i_squeeze_man[2]}]
set_property PACKAGE_PIN Y12 [get_ports {i_squeeze_man[3]}]
set_property PACKAGE_PIN AD11 [get_ports i_title]
set_property PACKAGE_PIN AD10 [get_ports i_gameover]
set_property PACKAGE_PIN AE10 [get_ports rst_vga]
set_property PACKAGE_PIN AE12 [get_ports rst]

set_property IOSTANDARD LVCMOS15 [get_ports {type_block2[1]}]
set_property IOSTANDARD LVCMOS15 [get_ports {type_block2[2]}]
set_property IOSTANDARD LVCMOS15 [get_ports {type_block2[3]}]
set_property IOSTANDARD LVCMOS15 [get_ports {type_block2[0]}]
set_property IOSTANDARD LVCMOS15 [get_ports {i_squeeze_man[0]}]
set_property IOSTANDARD LVCMOS15 [get_ports {i_squeeze_man[1]}]
set_property IOSTANDARD LVCMOS15 [get_ports {i_squeeze_man[2]}]
set_property IOSTANDARD LVCMOS15 [get_ports {i_squeeze_man[3]}]
set_property IOSTANDARD LVCMOS15 [get_ports i_title]
set_property IOSTANDARD LVCMOS15 [get_ports i_gameover]
set_property IOSTANDARD LVCMOS15 [get_ports rst_vga]
